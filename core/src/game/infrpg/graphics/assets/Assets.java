...
public final class Assets {
	...
	public static final SpriteAsset TEMPLATE_TILE = sa("maptiles/template");
	public static final SpriteAsset DIRT_TILE = sa("maptiles/dirt");
	public static final SpriteAsset GRASS_TILE = sa("maptiles/grass");
